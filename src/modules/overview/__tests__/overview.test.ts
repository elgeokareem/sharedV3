...
describe('Branch Tests', () => {
  ...
  const token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MzE5LCJkYk5hbWUiOiJycmFfZGIiLCJpYXQiOjE2Njk2NTIyNzgsImV4cCI6MTY3MjI0NDI3OH0.ZHeFXjfvHys6EmcD2ebmO86f14Y-DCnYFNGRN5n2lXY';
